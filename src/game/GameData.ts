...
const curatedMergers: MergerTarget[] = [
  {
    ...
    trust: 60,
    mood: "Reasonable",
    synergyText: "Start from zero standard! Activates instant +$150,000 daily seed cash dividends. Boosts local Meme tech stock values by +5%.",
    dailyIncome: 150000,
    techStockBoost: 1.05,
  ...
  },
  {
    ...
    trust: 50,
    mood: "Reasonable",
    synergyText: "Sustained green logistics. Generates high passive income of +$180,000/day. Boosts local Energy holdings by +12%.",
    dailyIncome: 180000,
    techStockBoost: 1.12,
  ...
  },
  {
    ...
    trust: 55,
    mood: "Reasonable",
    synergyText: "Pioneering therapeutic diagnostics. Yields passive licensing royalty dividends of +$220,000/day. Boosts Biotech stocks by +18%.",
    dailyIncome: 220000,
    techStockBoost: 1.18,
  ...
  },
  {
    ...
    trust: 45,
    mood: "Defensive",
    synergyText: "Unlocks global chip design networks. Generates stellar automation cashflows of +$280,000/day. Boosts Tech sector values by +25%.",
    dailyIncome: 280000,
    techStockBoost: 1.25,
  ...
  },
  {
    ...
    trust: 30,
    mood: "Greedy",
    synergyText: "Immediate defense empire supremacy. Delivers heavy sovereign government contract yields of +$350,000/day. Boosts Tech by +35%.",
    dailyIncome: 350000,
    techStockBoost: 1.35,
